...
Por medio de la presente se acuerda con el Ing. \authorname\hspace{1px} que su Trabajo Final de la \degreename\hspace{1px} se titulará ``\ttitle'', consistirá esencialmente en el monitoreo en tiempo real de un adulto mayor, y tendrá un presupuesto preliminar estimado de 611 hs de trabajo con fecha de inicio \fechaInicioName\hspace{1px} y fecha de presentación pública \fechaFinalName.
...
\item Diseño general del proyecto (35 hs)
	\begin{enumerate}
	\item Realización de diagrama de bloques. (8 hs)
	\item Obtener los componentes para el prototipo de pruebas. (12 hs)
	\item Diagrama de flujo del programa. (15 hs)	
\item Diseño de Hardware (64 hs)
	\item Requerimientos específicos. (3 hs)
	...
	\end{enumerate}
\item Diseño de Firmware (173 hs)
	\begin{enumerate}
	\item Requerimientos específicos. (3 hs)
	...
	\item Desarrollo del sistema en tiempo real. (35 hs)
	\item Desarrollo del firmware integral. (20 hs)
	\item Realizar pruebas de los sistemas en conjunto. (10 hs)
	\end{enumerate}
...
\item Implementación del prototipo (30 hs)
	...
	\end{enumerate}
\item Testing y depuración (118 hs)
	\begin{enumerate}
	\item Registrar las pruebas realizadas. (3 hs)
	\item Realizar pruebas de los sistemas. (25 hs)
	\item Realizar pruebas de comunicación. (25 hs)
	\item Realizar pruebas de la aplicación web.  (25 hs)
	\item Testear el sistema en conjunto. (20 hs)
	\item Analizar las experiencias de los usuarios finales. (20 hs)
	\end{enumerate}
...
Cantidad total de horas: (611 hs)
